...
As pointed out [here](https://twitter.com/davidrfeinberg/status/1375417579095924738), the default colour scheme looks a bit retro. Personally, I like the default stripe colour "#eff3f2", but you can change the stripe colour to anything you want :) 
...
2. Petersen, Maria Skaalum, et al. "Clinical characteristics of the Omicron variant-results from a Nationwide Symptoms Survey in the Faroe Islands." International Journal of Infectious Diseases 122 (2022): 636-643.

![](man/figures/paper_example2.jpg)

3. Petersen, Maria Skaalum, et al. "Clinical characteristics of the Omicron variant-results from a Nationwide Symptoms Survey in the Faroe Islands." International Journal of Infectious Diseases 122 (2022): 636-643.

![](man/figures/paper_example3.png)
...
![](man/figures/paper_example4.png)
